...
document.addEventListener('DOMContentLoaded', function () {
  ...
  _reactDom2.default.render(_jsx(Root, {
    store: store
  }), root);
});
...
var _errors_reducer = __webpack_require__(80);

var _errors_reducer2 = _interopRequireDefault(_errors_reducer);

var _session_reducer = __webpack_require__(150);
...
var _session_errors_reducer = __webpack_require__(81);
...
var _session_actions = __webpack_require__(149);
...
var log_in = exports.log_in = function log_in(user) {
  return {
    type: LOG_IN,
    user: user
  };
...
var log_out = exports.log_out = function log_out() {
  return {
    type: LOG_OUT
  };
};

var sign_up = exports.sign_up = function sign_up(user) {
  return {
    type: SIGN_UP,
    user: user
  };
...
var receive_current_user = exports.receive_current_user = function receive_current_user(user) {
  return {
...
var receive_session_errors = exports.receive_session_errors = function receive_session_errors(errors) {
  return {
...
var SessionReducer = function SessionReducer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : emptyUser;
  var action = arguments[1];
